...
export default function Cart() {
  ...
  return (
    <>
{carts?<section className="bg-white py-8 antialiased dark:bg-gray-900 md:py-16">
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              <dl className="flex items-center justify-between gap-4">
                ...
                <dd className="text-base font-medium text-gray-900 dark:text-white">{totalPrice} EGY</dd>
              </dl>
              ...
              <dl class="flex items-center justify-between gap-4">
                ...
                <dd class="text-base font-medium text-gray-900 dark:text-white">0 EGY</dd>
              </dl>
            ...
            <dl className="flex items-center justify-between gap-4 border-t border-gray-200 pt-2 dark:border-gray-700">
              ...
              <dd className="text-base font-bold text-green-500 dark:text-white">{totalPrice} EGY</dd>
            </dl>
        
          </div>
          <Link to="/checkout" className="flex bg-green-500 cursor-pointer hover:opacity-80 transition-opacity duration-1000 w-full items-center justify-center rounded-lg bg-primary-700 px-5 py-2.5 text-sm font-medium text-white hover:bg-primary-800 focus:outline-none focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Proceed to Checkout</Link>
          <div className="flex items-center justify-center gap-2">
            <span className="text-sm font-normal text-gray-500 dark:text-gray-400"> or </span>
            <Link to="/" href="#" title className="inline-flex items-center gap-2 text-sm font-medium text-primary-700  hover:no-underline dark:text-primary-500">
