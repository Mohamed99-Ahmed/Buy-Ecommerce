...
// increase count when click in it
  ...
  return (
    <>
      <div className="cart group rounded-lg border  border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 md:p-6">
        <div className="space-y-4 md:flex md:items-center md:justify-between md:gap-6 md:space-y-0">
          <img
            src={product.imageCover}
            alt={product.title}
            className="h-20 w-20 dark:hidden object-cover group-hover:scale-150 transition-transform duration-[1s]"
          />
          ...
          <div className="w-full min-w-0 flex-1 space-y-4 md:order-2 md:max-w-md">
            ...
            <div className="flex items-center gap-4">
              <button
                type="button"
                className="favorite inline-flex group items-center text-sm font-medium text-gray-500 hover:text-gray-900  dark:text-gray-400 dark:hover:text-white"
              >
              ...
              onClick={()=>{deleteCart(product._id)}}
                type="button"
                className="space-x-1 inline-flex items-center text-sm font-medium text-red-600 hover:underline dark:text-red-500"
              >
